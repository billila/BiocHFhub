...
#' using the hfhub package. It is mainly used to retrieve model weights or
#' configuration files.
#'
#' @param model_id Character string specifying the model repository id
#' (e.g., "facebook/esm2_t33_650M_UR50D").
#' @param filename Character string specifying the file to download
...
download_hfbio_model <- function(model_id, filename = "config.json") {
    ...
    stop("The 'hfhub' package is required but not installed.
